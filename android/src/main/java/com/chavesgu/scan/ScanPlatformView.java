...
public class ScanPlatformView implements PlatformView, MethodChannel.MethodCallHandler, ScanViewNew.CaptureListener, ScanDrawView.ExceptionListener {
    ...
    private void initForBinding(Map<String, Object> args) {
        ...
        try {
            ...
            this.scanDrawView.setCaptureListener(this);
            this.parentView.addView(this.scanDrawView);
        } catch (Throwable e) {
            onException(Log.getStackTraceString(e));
        }
    }
    ...
    @Override
    public void onException(String text) {
        channel.invokeMethod("scanDrawViewException", text);
    }
}
